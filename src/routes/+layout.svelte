<script lang="ts">
	import '../app.css';
	import type { PageServerData } from './demo/lucia/$types';
	import logo from '$lib/asset/image/Doppelganger.png';
...
<div class="navbar bg-base-100 shadow-sm">
	...
	<div class="navbar-center">
		<a href="/" class="btn btn-ghost text-xl">Mini-MarkManson Chatbot</a>
	</div>
